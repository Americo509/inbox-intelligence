...
h.logarithm = h.log = function (e) {
	...
	if (((i = this.d), this.s < 0 || !i || !i[0] || this.eq(1)))
		return new c(i && !i[0] ? -1 / 0 : this.s != 1 ? NaN : i ? 0 : 1 / 0);
	if (n)
		if (i.length > 1) s = !0;
		else {
...
h.minus = h.sub = function (e) {
	...
	if (
		((i = b(e.e / m)), (c = b(this.e / m)), (f = f.slice()), (s = c - i), s)
	) {
		for (
			a = s < 0,
				a
...
h.plus = h.add = function (e) {
	...
	if (
		((s = b(this.e / m)), (t = b(e.e / m)), (f = f.slice()), (r = s - t), r)
	) {
		for (
			r < 0
				? ((i = f), (r = -r), (o = c.length))
...
h.squareRoot = h.sqrt = function () {
	var e,
		...
		c = this.constructor;
	if (f !== 1 || !u || !u[0])
		return new c(!f || (f < 0 && (!u || u[0])) ? NaN : u ? this : 1 / 0);
	for (
		w = !1,
			f = Math.sqrt(+this),
			f == 0 || f == 1 / 0
